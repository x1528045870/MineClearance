...
public class AIController2 {
    private AIGamePanel2 gamePanel;
    private Player onTurn;
    private int xCount;
    private int yCount;
    private int mineCount;
    private AIScoreBoard scoreBoard;
    public AIController2(int Row,int Column,int Mine ) {
        this.xCount=Column;
        this.yCount=Row;
        this.mineCount=Mine;
        this.init();
    ...
    public AIGamePanel2 getGamePanel() {
        return gamePanel;
    }

    public void setGamePanel(AIGamePanel2 gamePanel) {
